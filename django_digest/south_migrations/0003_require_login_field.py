...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PartialDigest.login'
        # (to signature: django.db.models.fields.CharField(max_length=75, db_index=True))
        db.alter_column('django_digest_partialdigest', 'login', orm['django_digest.partialdigest:login'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PartialDigest.login'
        # (to signature: django.db.models.fields.CharField(max_length=75, null=True, db_index=True))
        db.alter_column('django_digest_partialdigest', 'login', orm['django_digest.partialdigest:login'])
    ...
    models = {
        ...
        'django_digest.partialdigest': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'login': ('django.db.models.fields.CharField', [], {'max_length': '75', 'db_index': 'True'}),
